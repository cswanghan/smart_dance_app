...
export function PostCard({ post }: PostCardProps) {
  ...
  const handleLike = () => {
    ...
    // In a real app, you would send a request to the backend to update the like count
  };
    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center text-gray-600 text-sm">
          <button onClick={handleLike} className="flex items-center mr-4 hover:text-red-500 transition-colors duration-200">
